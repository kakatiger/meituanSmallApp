...
}(require("../../npm/babel-runtime/regenerator/index.js")), n = require("../../npm/@dp/owl-wxapp/es6/index.js"), r = require("../../api/index.js"), o = r.previewRiskCheckResendCode, a = r.orderValidate, i = require("../../npm/promise-polyfill/promise.js"), s = require("../../utils/mix.js"), c = require("../base.js"), u = require("../../weapp-redux/index.js").connect, d = {
    data: {
        verifyPhoneCode: "",
            ...
            return t.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                  case 0:
                    ...
                    s = a.wm_verify_user_type, c = 2 === (n || s) ? 2 : 1, u = r.store.getState(), d = u.purchase.token, 
                    e.next = 8, o({
                        phone: i,
                        order_token: d,
                  ...
                  case 12:
                    e.prev = 12, e.t0 = e.catch(1), h = e.t0.message, r.alert({
                        message: h
                    });
