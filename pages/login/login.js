...
var a = function(e) {
...
}(require("../../npm/babel-runtime/regenerator/index.js")), n = require("../../npm/@dp/owl-wxapp/es6/index.js"), r = require("../../actions/user.js"), o = require("../../npm/promise-polyfill/promise.js"), s = require("../../constants.js").KEY_USER_INFO, c = require("../../api/wx.js"), i = c.login, u = c.getUserInfo, d = require("../../api/index.js"), p = d.accountLogin, h = d.verifyCodeSend, l = d.verifyCodeCheck, f = d.getCaptchaUrl, g = require("../../utils/wx.js").storage.setItem, m = require("../base.js"), v = require("../../weapp-redux/index.js").connect, C = require("../../components/open-setting/open-setting.js"), w = require("../../utils/mix.js"), x = function(e) {
            ...
            return a.default.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                  ...
                  case 12:
                    ...
                    i && -1 !== i.indexOf("getUserInfo") && -1 !== i.indexOf("auth") ? (d = wx).openSetting ? e.openSettingShow() : e.alert({
    ...
    encryptParam: function(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : this, a = t.encryptData, n = t.encryptedData, r = t.iv;
        return n && r ? (e.encryptedData = n, e.iv = r) : e.encryptData = a, e;
    },
    login: function() {
        var e = this;
        return t(a.default.mark(function t() {
            var n, r, o, s, c, d, h, l, f, g, m, v, C;
            return a.default.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                  case 0:
                    return t.next = 2, i();
                  ...
                  case 6:
                    return o = t.sent, s = o.rawData, c = o.signature, d = o.encryptData, h = o.encryptedData, 
                    l = o.iv, f = o.userInfo, t.next = 15, x(f);
                  ...
                  case 17:
                    if (g = t.sent, m = g.openId, v = g.code, C = g.message, e.open_id = m, e.rawData = s, 
                    e.signature = c, e.encryptData = d, e.encryptedData = h, e.iv = l, g.userInfo = f, 
                    0 !== v) throw {
                        code: v,
                        message: C,
                        msg: C,
        ...
        return t(a.default.mark(function t() {
            ...
            return a.default.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                  ...
                  case 4:
                    return n = e.open_id, r = e.rawData, o = e.signature, s = e.data, c = s.inputPhoneNumber, 
                    i = s.inputCaptcha, t.abrupt("return", h(e.encryptParam({
                        phone: c,
                        openId: n,
                        rawData: r,
                        signature: o,
    ...
    onClickClearInput: function(t) {
        ...
        this.setData(e({}, r, " ")), this.setData((e(a = {}, n, ""), e(a, r, ""), a));
    },
    ...
    onOpenSettingSucc: function() {
        var e = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).detail;
        (void 0 === e ? {} : e).userInfo && (this.openSettingHide(), this.auth());
    }
});

(0, n.page)(w(k, v(null, function(e) {
    return {
