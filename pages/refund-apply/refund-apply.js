...
var t = function(e) {
...
}(require("../../npm/babel-runtime/regenerator/index.js")), a = require("../../npm/@dp/owl-wxapp/es6/index.js"), r = require("../base.js"), n = require("../../utils/format-price.js"), s = require("../../api/index.js"), i = s.refundApplyPreview, o = s.refundApplySubmit, c = s.refundApplyCalculate, u = r({
            ...
            return t.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                  ...
                  case 26:
                    ...
                    for (q = d[R], O = q.attrs, z = [], K = !(F = !0), N = void 0, e.prev = 33, W = O[Symbol.iterator](); !(F = (L = W.next()).done); F = !0) B = L.value, 
                    z.push(B.value);
                    e.next = 41;
                    break;
                  ...
                  case 64:
                    ...
                    if (Y = (X = Q || {}).failure_description, Z = void 0 === Y ? "" : Y, $ = X.poi_phone, 
                    ee = void 0 === $ ? "" : $, Z && ee) return a.confirm({
                        message: Z,
                        cancel: function() {
                            wx.makePhoneCall({
                                phoneNumber: ee
    ...
    upload: function(e, t) {
        ...
        s.uploadFile({
            ...
            fallback: function() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "", a = s.data.fakePictures;
            ...
            success: function(t) {
                ...
                e.checkUploadState(), e.setData({
                    ...
                    o.forEach(function(t, r) {
                        ...
                        n <= s || (e.matchUploadSize(o) ? e.upload(t, s) : e.toast({
    ...
    chooseAll: function(e) {
        if (e = "boolean" == typeof e && e, 0 === this.data.support_part_refund) this.toast({
            ...
            n = a && !e ? (s.forEach(function(e) {
                e.selected_count = 0, e.checked = !1;
            }), r = 0, a = !1, 1) : (s.forEach(function(e) {
                e.selected_count = e.count, e.checked = !0;
            }), r = this.data.food_selected_available, a = !0, 0), this.setData({
                select_all: a,
                refund_category: n,
                foods: s,
                food_selected: r
    ...
    refundRemove: function(e) {
        var t = e.currentTarget.dataset.index, a = this.data.food_selected, r = this.data.foods, n = r[t];
        0 < n.selected_count && (a -= 1, n.selected_count -= 1, 0 === n.selected_count && (n.checked = !1), 
        this.setData({
            foods: r,
            food_selected: a,
            select_all: !1,
    ...
    updateRefundText: function(e) {
        ...
        return t && 200 <= t.length && (this.toast({
            message: "最多200字哦~"
        }), 200 < t.length) ? t.substring(0, t.length - 1) : (this.setData({
            reason_text: t.trim()
        }), t);
    },
            ...
            return t.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                  case 0:
                    ...
                    _ = n.pictures, 0 === i) return a.toast({
                        message: "请选择要退款的商品"
                    }), e.abrupt("return", !1);
                    e.next = 5;
                    break;
                  ...
                  case 8:
                    if (p = c[u], h = p.reason_type, v = p.reason_id, 4 === h && "" === d) return a.toast({
                        message: "请描述退款原因"
                    }), e.abrupt("return", !1);
                    e.next = 12;
                    break;
