...
module.exports = function(i) {
    t(i, {
        ...
        checkCurrentIfNeedToLoadMore: function(t) {
            var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0, i = t, s = this.data, o = s.spuScrollHeight, a = s.spuTagPositionList, r = this.store.getState().poi.food_spu_tags, n = void 0 === r ? [] : r;
            if (o && a) for (var c = 0; a[c + t] - a[t] < o; c++) i = c; else {
                var l = n.length - 1, h = n[t].spus.length - e, u = 0;
                if (6 < h) i = t; else for (;h <= 6; ) {
                    if (l <= (i = t + ++u)) {
                        i = l;
                        break;
                    }
