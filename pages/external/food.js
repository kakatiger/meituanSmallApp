...
}(require("../../npm/babel-runtime/regenerator/index.js")), n = require("../../npm/@dp/owl-wxapp/es6/index.js"), o = require("../../api/index.js"), i = o.foodShare, a = o.grabPoiCouponByPhone, s = require("../../api/analytics.js").event, r = require("../../npm/promise-polyfill/promise.js"), u = require("../base.js"), p = (0, 
require("../../weapp-redux/index.js").connect)()(u({
    ...
    navigateToLogin: function() {
        var e = "../login/login?afterLoginAction=" + (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "");
        wx.navigateTo({
            url: e
        });
    },
            ...
            return t.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                  case 0:
                    ...
                    if (o.afterLoginAction = "", "grabCoupons" === a) return e.next = 7, i({
                        wm_poi_id: n.data.wm_poi_view_id,
                        spu_id: n.data.spu_id
                    });
                    e.next = 9;
