            ...
            return t.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                  case 0:
                    ...
                    if (n.afterLoginAction = "", "grabCoupons" === a) return e.next = 7, i({
                        wm_poi_id: o.data.wm_poi_view_id,
                        from_act_id: o.data.from_act_id
                    });
                    e.next = 9;
