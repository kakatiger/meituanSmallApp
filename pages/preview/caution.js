var t = require("../../npm/@dp/owl-wxapp/es6/index.js"), e = require("../../utils/object-assign.js"), a = require("../../actions/purchase.js").setRecipient, s = require("../../weapp-redux/index.js").connect, i = require("../../utils/mix.js"), u = require("../base.js"), r = {
    data: {
        selects: [],
        text: "",
        currentValue: "",
    ...
    onInputCaution: function(t) {
        ...
        50 <= e.length && 50 <= a.length && this.toast({
            message: "备注最多输入50字哦",
    ...
    onLoad: function() {
        var t = this.store.getState().purchase.caution, a = getApp(), s = a.remark_field, i = {
            currentValue: t,
            text: t,
            focus: !(a.remark_field = null)
        };
        if (s) {
