    ...
    return function() {
        ...
        try {
            wx.onAccelerometerChange(function(t) {
                s.system.accelerometer || (s.system.accelerometer = []), 20 < s.system.accelerometer.length && s.system.accelerometer.shift(), 
                ...
                s.system.compass || (s.system.compass = []), 20 < s.system.compass.length && s.system.compass.shift(), 
