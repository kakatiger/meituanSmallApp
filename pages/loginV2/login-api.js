...
var n = e(require("../../npm/babel-runtime/regenerator/index.js")), a = require("../../actions/user.js"), r = e(require("./yoda-modules/index/yoda.js")), i = require("./finger.js"), o = require("../../api/index.js"), s = o.accountLoginV2, c = o.appleMobileV2, u = o.bindMobileV2, p = o.ticketLoginV2, d = require("../../api/wx.js"), h = d.login, g = d.getUserInfo, l = require("../../constants.js").KEY_USER_INFO, f = require("../../utils/wx.js").storage, _ = f.setItem, x = f.getItem, v = require("../../weapp-redux/index.js").connect, m = require("../../utils/mix.js"), k = require("./log.js"), b = function(e) {
    ...
    onCheckPhoneNumber: function(e) {
        ...
        3 < n.length && (n = n.substring(0, 3) + " " + n.substring(3, n.length)), 8 < n.length && (n = n.substring(0, 8) + " " + n.substring(8, n.length));
        var r = this.config.type;
        return t !== this.isRight && (this.isRight = t, this.setData({
            iptPhone: {
                show: 1 === r,
                inputValue: n,
                type: "iptPhone",
        ...
        })), 0 === r && this.firstInput && (this.lxInputClick(), this.firstInput = !1), 
        n;
    },
        ...
        return t(n.default.mark(function t() {
            ...
            return n.default.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                  case 0:
                    if (e.nextTap) return t.abrupt("return");
                    t.next = 2;
                    break;

                  case 2:
                    if (a = e.data.iptPhone.inputValue, r = e.data.iptPhone.isRight, i = e.config.type, 
                    e.lxInputNextClick(i, r ? 0 : 1), r) return e.nextTap = !0, e.mobile = a.replace(/\s/g, ""), 
                    t.prev = 9, t.next = 12, c(Object.assign(e._encryptParam()));
                    t.next = 24;
                    break;
                  ...
                  case 17:
                    t.prev = 17, t.t0 = t.catch(9), t.t0.code, u = t.t0.msg, o = t.t0.data, e.nextTap = !1, 
                    e.alert({
                        message: u
                    });
            ...
            return n.default.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                  ...
                  case 10:
                    ...
                    d = p.openid, e.openid = d), h = c && -1 !== c.indexOf("getUserInfo") && -1 !== c.indexOf("auth"), 
                    g = e.config.type, wx.canIUse && wx.canIUse("button.open-type.getUserInfo") || !(-1 < c.indexOf("unauthorized"))) {
                        t.next = 21;
                        break;
                    }
                    return wx.showModal({
                  ...
                  case 21:
                    h ? console.log(c) : 101155 === s ? 1 === g ? (e.lxInputModalView(g), e.nextTap = !1, 
                    e.iptPhone({
                        ok: function() {
                            e.onNextCheck();
                        },
        ...
        return t(n.default.mark(function e() {
            ...
            return n.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                  ...
                  case 15:
                    c = e.sent, p = c.login_data, d = p.userid, h = p.token, a._goToSuccess({
                        userid: d,
                        openid: a.openid,
                        token: h
                    }), e.next = 27;
                  ...
                  case 21:
                    e.prev = 21, e.t1 = e.catch(12), g = e.t1.code, s = e.t1.msg, o = e.t1.data, 101188 === g ? (l = o.multi_bound_account_datas, 
                    f = l.ticket, _ = l.userid, a.ticketLogin({
                        userid: _,
                        ticket: f
                    })) : a.alert({
                        message: s
        ...
        return t(n.default.mark(function e() {
            ...
            return n.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                  ...
                  case 9:
                    e.prev = 9, e.t0 = e.catch(0), e.t0.code, u = e.t0.msg, t = e.t0.data, a.alert({
                        message: u
                    });
