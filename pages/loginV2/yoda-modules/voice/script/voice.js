...
var o = e(require("../../utils/api.js")), t = require("../../utils/config.js"), i = e(require("../../slidervalid/script/slider.plugin.js")), c = new o.default(), a = (getApp(), 
{
    ...
    initVoiceSDK: function() {
        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, o = e.data, i = e.success, c = e.fail, a = e.style, r = void 0 === a ? null : a;
        ...
        r && 0 < Object.keys(r).length && (s = r.mobileInput, n = r.codeInput, l = r.codeButton, 
        ...
        i && (r = ""), c.verify({
            ...
            if (1 === t) {
                ...
                if ("string" == typeof o.callBackSuccess) {
                    ...
                    r = 0 < o.callBackSuccess.indexOf("?") ? "&" + r : "?" + r, o.navigate({
                        options: u,
        ...
        wx.showToast({
            ...
            complete: function() {
                if ("string" == typeof c.callBackFail) {
                    ...
                    e = 0 < c.callBackFail.indexOf("?") ? "&" + e : "?" + e, c.navigate({
                        options: a,
    ...
    bindMobileInput: function(e) {
        ...
        11 === (t.mobile = o).length ? (t.sendVoiceDisa = !1, t.voiceButColor = "#666") : (t.sendVoiceDisa = !0, 
    ...
    bindVoiceCodeInput: function(e) {
        var o = e.detail.value, t = this.data.voiceInfo;
        1 < (t.voicecode = o).length && !0 === t.isSend ? (t.opacity = 1, t.verifyDisa = !1) : (t.opacity = .5, 
