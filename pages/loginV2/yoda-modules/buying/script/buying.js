...
}(require("../../utils/api.js")), e = require("../../utils/config.js"), a = new t.default(), o = (getApp(), 
{
    ...
    initBuyingSDK: function() {
        var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, a = t.data, o = t.success, i = t.fail, n = t.style, r = void 0 === n ? null : n;
            ...
            if (1 === a) {
                ...
                try {
                    for (var f, h = s[Symbol.iterator](); !(u = (f = h.next()).done); u = !0) {
                        var y = f.value;
                        y.couponTitle = 25 < y.couponTitle.length ? y.couponTitle.substring(0, 24) + "..." : y.couponTitle, 
                        y.checked = !1;
                    }
                } catch (e) {
                    l = !0, d = e;
        ...
        a.verify({
            ...
            if (1 === a) {
                ...
                if (i.show = !1, e.setData({
                    ...
                    s = 0 < e.callBackSuccess.indexOf("?") ? "&" + s : "?" + s, e.navigate({
                        options: d,
    ...
    bindRadioChange: function(t) {
        ...
        a.purchaseddeal[0] = e, a.opacity = 1;
        var o = !(a.verifyDisa = !1), i = !1, n = void 0;
        try {
        ...
        wx.showToast({
            ...
            complete: function() {
                if ("string" == typeof i.callBackFail) {
                    ...
                    t = 0 < i.callBackFail.indexOf("?") ? "&" + t : "?" + t, i.navigate({
                        options: n,
