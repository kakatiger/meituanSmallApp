...
var e = function(t, e) {
    ...
    function s(e) {
        ...
        t(this, s);
        var u = (n.default.getSystemInfo() || {}).windowWidth, c = void 0 === u ? 375 : u, l = c / 375, d = [ 50 * l, 50 * l ], h = [ 270 * l, 52 * l ], f = [ 50 * l, 50 * l ], v = Date.now(), p = h[0] - d[0];
        Object.assign(this, {
            requestCode: i,
            windowWidth: c,
            zoom: l,
    ...
    return i(s, [ {
        ...
        value: function(t) {
            ...
            return r < 0 && (r = 0), o <= r && (r = o, this.isDone = !0, this.slidEnd()), {
                deltaX: r,
                slideWidth: o,
                isDone: a
            };
        ...
        value: function() {
            ...
            }), t.trajectory = e, t.points = null, 3e3 < a[a.length - 1] - a[0] && (t.timeout += 1), 
            t.setData();
