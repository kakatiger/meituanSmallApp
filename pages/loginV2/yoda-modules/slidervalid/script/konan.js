function r(r, f) {
    return null == r || 0 === r.length ? r : (r = t(r), f = t(f), e(a(n(r, !0), o(n(f, !1))), !1));
}
...
function t(r) {
    ...
    for (var t = [], e = r.length, n = 0, o = 0; n < e; ++n, ++o) {
        ...
        if (a < 128) t[o] = r.charAt(n); else if (a < 2048) t[o] = String.fromCharCode(192 | a >> 6, 128 | 63 & a); else if (a < 55296 || 57343 < a) t[o] = String.fromCharCode(224 | a >> 12, 128 | a >> 6 & 63, 128 | 63 & a); else if (n + 1 < e) {
...
function n(r, t) {
    var e, n = r.length, o = n >> 2;
    0 != (3 & n) && ++o, t ? (e = new Array(o + 1))[o] = n : e = new Array(o);
    for (var a = 0; a < n; ++a) e[a >> 2] |= r.charCodeAt(a) << ((3 & a) << 3);
    return e;
}
...
function a(r, t) {
    ...
    for (n = r[h], i = (o = 0) | Math.floor(6 + 52 / u); 0 < i; --i) {
...
var f = function() {
    ...
    return function(t) {
        var e, n, o, a, f, i, u;
        for (n = o = 0, a = t.length, i = (a -= f = a % 3) / 3 << 2, 0 < f && (i += 4), 
