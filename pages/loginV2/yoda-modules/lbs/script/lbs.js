...
}(require("../../utils/api.js")), e = require("../../utils/config.js"), o = new t.default(), a = (getApp(), 
{
    ...
    initLbsSDK: function() {
        var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, o = t.data, a = t.success, s = t.fail, i = t.style, n = void 0 === i ? null : i;
        ...
        o.verify({
            ...
            if (1 === o) {
                ...
                if (s.show = !1, e.setData({
                    ...
                    c = 0 < e.callBackSuccess.indexOf("?") ? "&" + c : "?" + c, e.navigate({
                        options: f,
    ...
    bindRadioChange: function(t) {
        ...
        o.geolocation[0] = e, o.opacity = 1;
        var a = !(o.verifyDisa = !1), s = !1, i = void 0;
        try {
        ...
        wx.showToast({
            ...
            complete: function() {
                if ("function" == typeof s.callBackFail && s.callBackFail({
                    ...
                    t = 0 < s.callBackFail.indexOf("?") ? "&" + t : "?" + t, s.navigate({
                        options: i,
