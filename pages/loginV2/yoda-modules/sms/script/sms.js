...
var t = s(require("../../utils/api.js")), e = require("../../utils/config.js"), o = s(require("../../slidervalid/script/slider.plugin.js")), a = s(require("../../image/script/image.js")), i = new t.default(), r = getApp(), n = {
    ...
    initSmsSDK: function() {
        var s = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, t = s.data, o = s.success, a = s.fail, i = s.style, n = void 0 === i ? null : i;
        ...
        n && 0 < Object.keys(n).length && (l = n.mobileInput, d = n.codeInput, u = n.codeButton, 
        ...
        o && (r = ""), i.verify({
            ...
            if (1 === e) {
                ...
                if ("string" == typeof t.smsCallBackSuccess) {
                    ...
                    r = 0 < t.smsCallBackSuccess.indexOf("?") ? "&" + r : "?" + r, t.navigate({
                        options: u,
    ...
    smsExit: function() {
        var s = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, t = s.text, e = s.code, o = s.msg, a = this, i = this.data.smsInfo.data.options;
        wx.showToast({
            title: t,
            icon: "none",
            mask: !0,
            ...
            complete: function() {
                if ("function" == typeof a.smsCallBackFail && a.smsCallBackFail({
                    ...
                    s = 0 < a.smsCallBackFail.indexOf("?") ? "&" + s : "?" + s, a.navigate({
                        options: i,
    ...
    bindMobileInput: function(s) {
        ...
        11 !== (e.mobile = t).length || isNaN(Number(t)) ? (e.sendSmsDisa = !0, e.smsButColor = "#B6B6B6") : (e.sendSmsDisa = !1, 
    ...
    bindSmsCodeInput: function(s) {
        ...
        1 < (e.smscode = t).length && !0 === e.isSend ? (e.opacity = 1, e.verifyDisa = !1) : (e.opacity = .5, 
