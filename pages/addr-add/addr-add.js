...
var t = function(e) {
    ...
    getArgs: function() {
        var e = 0 < arguments.length && void 0 !== arguments[0] && arguments[0], t = this.id, a = this.action, n = this.actions, s = this.source, i = this.sources, r = this.data, o = r.name, u = r.address, c = r.house_number, d = r.phone, h = r.gender, l = this.latitude, p = this.longitude, g = this.poi_id;
        return {
            type: n[a] || n.add,
            id: t,
            name: o,
    ...
    onClickSubmit: function() {
        ...
        return e(t.default.mark(function n() {
            var s, i, r, o, u, c, h, l, p, g, f, v, x, w, b, _;
                ...
                for (;;) switch (n.prev = n.next) {
                  case 0:
                    for (i = (s = [ {
                        ...
                        id: "address",
                        msg: "请选择正确的地址"
                    } ]).length, r = a.data, o = {}, u = "", c = 0; c < i; ++c) l = (h = s[c]).id, p = h.msg, 
                    g = h.test, (f = r[l]) && (!g || g(f)) || (o["valid" + l] = !1, u || (u = p));
                    if (!u) {
                        n.next = 10;
                        break;
                    }
                  ...
                  case 10:
                    return a.loading(!0), v = a.getArgs(), n.prev = 12, n.next = 15, d(v);

                  case 15:
                    x = n.sent, w = x.id, b = x.over_shipping, _ = x.over_shipping_txt, 1 === b ? a.confirm({
                        message: _,
                        textOK: "仍然保存",
                        textCancel: "调整地址",
                        ok: function() {
                    ...
                    }) : ("preview" === a.from && a.setRecipient(m(v, {
                        id: w
            ...
            this.confirm({
                ...
                ok: (a = e(t.default.mark(function e() {
                    ...
                    return t.default.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                          case 0:
                            return n.loading(!0), e.prev = 1, a = n.getArgs(!0), e.next = 5, d(m(a, {
                                type: 2
                            }));
                          ...
                          case 8:
                            e.prev = 8, e.t0 = e.catch(1), s = e.t0.message, n.alert({
                                message: s
                            });
    ...
    addrFilter: function(e) {
        ...
        return 0 <= d ? (u = t.slice(0, d), c = t.slice(d + o.length)) : o = "", 0 < (r = parseInt(r, 10)) && (1e3 <= r ? (r = (r / 1e3).toFixed(1), 
        r += "千米") : r += "米"), {
            prename: u,
            poiName: o,
            leftName: c,
                ...
                for (;;) switch (e.prev = e.next) {
                  ...
                  case 16:
                    r = e.sent, (i = r.result) && (a.setData({
                        locCity: i
                    }), (o = getApp()).eventBus.fire("city:changed", i)), e.next = 24;
                    break;
    ...
    onLoad: function(e) {
        ...
        if ("edit" === i && l.id && o && String(l.id) === o) {
            this.id = o;
            var p = l.name, g = l.gender, f = l.address, m = l.house_number, v = l.phone, x = l.longitude, w = l.latitude, b = l.bind_type;
            this.longitude = x, this.latitude = w, this.bind_type = b, this.setData({
                action: i,
