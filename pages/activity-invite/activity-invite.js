...
var e = function(t) {
        ...
        return t(e.default.mark(function t() {
            ...
            return e.default.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                  ...
                  case 3:
                    (o = (o = t.sent) || {}).data = o.data || {}, 0 === o.code ? n.setData({
        ...
        return t(e.default.mark(function t() {
            ...
            return e.default.wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                  ...
                  case 3:
                    (o = (o = t.sent) || {}).data = o.data || {}, 0 === o.code ? (a.setData({
                        showMainContent: !0,
    ...
    goToWebView: function(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, a = this.data, n = a.token, i = a.shareConfig;
        this.updateWebview({
            webviewUrl: t,
            loginData: {
                token: n
