...
module.exports = function() {
    var r = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : o, e = arguments[1], n = [ "act17", "act20", "act23", "act41" ];
    switch (e.type) {
      case a.POI_REQUEST:
        return u({}, o, {
            id: e.id
      ...
      case a.POI_LOADED:
        ...
        return u(f, i.sku.get(_)), u(d, i.spu.get(_)), c.forEach(function(a) {
            a.icon = t(a.icon, 0, 0, "o"), a.spus.forEach(function(u) {
                (d[u.id] = u).picture = t(u.picture, 300), u.skus.forEach(function(t) {
      ...
      case a.POI_PRODUCTS:
        ...
        E.forEach(function(a) {
            (k[a.id] = a).picture = t(a.picture, 300), a.skus.forEach(function(t) {
      ...
      case a.PRODUCTS_COLLECT:
        ...
        return e.data.forEach(function(a) {
            (j[a.id] = a).picture = t(a.picture, 300), a.skus.forEach(function(t) {
