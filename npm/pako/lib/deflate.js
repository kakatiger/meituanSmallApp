function t(i) {
    ...
    var f = this.options;
    f.raw && 0 < f.windowBits ? f.windowBits = -f.windowBits : f.gzip && 0 < f.windowBits && f.windowBits < 16 && (f.windowBits += 16), 
...
t.prototype.push = function(t, i) {
    ...
    do {
        ...
        1 !== (r = e.deflate(h, o)) && r !== u) return this.onEnd(r), !(this.ended = !0);
