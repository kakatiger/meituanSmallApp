...
!function(t) {
    function e(t, r, e, i) {
        var a, c, u, h, l = r && r.prototype instanceof o ? r : o, y = Object.create(l.prototype), d = new s(i || []);
        return y._invoke = (a = t, c = e, u = d, h = S, function(t, r) {
            if (h === j) throw new Error("Generator is already running");
            if (h === O) {
                if ("throw" === t) throw r;
                return p();
            }
            for (u.method = t, u.arg = r; ;) {
                ...
                if ("next" === u.method) u.sent = u._sent = u.arg; else if ("throw" === u.method) {
                    if (h === S) throw h = O, u.arg;
                    u.dispatchException(u.arg);
                } else "return" === u.method && u.abrupt("return", u.arg);
                h = j;
                var i = n(a, c, u);
                if ("normal" === i.type) {
                    if (h = u.done ? O : _, i.arg === k) continue;
                    return {
                        value: i.arg,
                        done: u.done
                    };
                }
                "throw" === i.type && (h = O, u.method = "throw", u.arg = i.arg);
            }
        }), y;
    }
    function n(t, r, e) {
