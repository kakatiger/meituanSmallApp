...
var a = {
    ...
    touchM: function(t) {
        ...
        } else e.isDelShow && (e.right = 0 < this.data.btnWidth + i ? this.data.btnWidth + i : 0, 
    ...
    touchE: function(t) {
        ...
        0 <= i ? e.isDelShow || (i >= this.data.btnWidth / 2 ? (e.right = this.data.btnWidth, 
        e.isDelShow = !0) : (e.right = 0, e.isDelShow = !1), this.setDrawListData(a, e)) : (e.isDelShow ? Math.abs(i) >= this.data.btnWidth / 2 ? (e.right = 0, 
        e.isDelShow = !1) : (e.right = this.data.btnWidth, e.isDelShow = !0) : (e.right = 0, 
