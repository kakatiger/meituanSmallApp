...
var e = function(t) {
                ...
                for (;;) switch (t.prev = t.next) {
                  case 0:
                    if (i = r.data.locSearch, c = i.activeTab, s = i.cityShow, r.onSearchClear(), r.setSearchData({
                        activeTab: c ? "" : "select",
                        cityShow: !s
                    }), s || r.data.locSearch.cityList.length) return t.abrupt("return");
                    t.next = 5;
                    break;
    ...
    cityScroll: function(t) {
        if (this.scrollEnable) for (var e = t.detail.scrollTop, a = this.data.locSearch.cityList, r = 0, i = 0, c = 0, s = 0; s < a.length; s++) if (r < e) {
            if (e <= (r = 30 * (c += 1) + 41 * (i += a[s].cities.length))) {
