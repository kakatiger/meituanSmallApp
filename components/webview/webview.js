...
Component({
    ...
    methods: {
        compareVersion: function(e, t) {
            ...
            for (i = 0; i < n; i++) {
                if (r = parseInt(e[i], 10), (o = parseInt(t[i], 10)) < r) return 1;
                if (r < o) return -1;
            }
            return 0;
        },
        ...
        getHash: function() {
            var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "", t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], r = "", o = e.indexOf("#");
        ...
        serialize: function(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, r = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}, i = "", n = -1 !== e.indexOf("?") ? "&" : "?", a = this.getHash(e), l = a.url, u = a.hash, h = void 0 === u ? "" : u;
