...
var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
    ...
    try {
        ...
        var l = a[r - 2];
        1 < r && (n = l.__route__, e = l.getReportData());
    } catch (t) {
        console.error(t);
    }
    return [ i, t, e, o, n ];
    ...
    if (c) return c;
    var t = a.getState(), e = t.wx, o = e.system, n = e.windowWidth, i = e.windowHeight, r = e.model, s = e.networkType, u = t.dev.uuid, l = /^(.*)\s((?:\d+\.)+\d+)$/.exec(o), d = "ios" === (l ? l[1] : "").toLowerCase() ? "iphone" : "android", h = o.replace(/\s+/g, "_");
    return c = {
        sr: n + "x" + i,
        vp: n + "x" + i,
        uuid: u,
...
e.MAX_URL_LENGTH = 2083, e.prototype = {
    ...
    send: function(t) {
        t.version = "0.6.0-beta1", "GET" === this.method && (0 <= this.url.indexOf("?") ? this.url += "&" + l(t) : this.url += "?" + l(t)), 
    ...
    data: function() {
        try {
            ...
            if (!t) return null;
            var e = t.timing, o = e.navigationStart, n = e.domainLookupStart, i = e.connectStart, a = e.connectEnd, r = e.fetchStart, s = e.domainLookupEnd, c = e.responseStart, u = e.requestStart, l = e.responseEnd, d = e.loadEventEnd, h = e.loadEventStart, f = e.domComplete, g = e.domLoading;
            return {
                redirect: r - o,
                dns: s - n,
                connect: a - i,
    ...
    push: function() {
        ...
        for (var r = i.length, s = 0; s < r; s++) try {
            var c, u = i[s];
            "function" == typeof u ? i[s](this) : (c = this[(u = e.call(u, 0))[0]]).call.apply(c, [ this ].concat(t(u.slice(1))));
        } catch (e) {
            o += 1;
        }
        return o;
    ...
    timing: function(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 1, o = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
    ...
    _push: function(t, e) {
        var o = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : this._tags;
        this._queue.push({
            type: t,
            data: e,
            tags: o
    ...
    _send: function() {
        if (this._isSampleHit()) {
            ...
            if (n = Object.assign(n, e), this._queue.length) if (t) 1 === this._queue.length ? n = Object.assign(n, this._queue[0]) : n.data = this._queue, 
            this._beacon.send(n); else for (var i = 0, a = this._queue.length; i < a; i++) n = Object.assign(n, this._queue[i]), 
            this._beacon.send(n);
            this._queue = [];
        }
    },
    ...
    for (var e = getApp(), n = arguments.length, i = Array(1 < n ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
    if (e && e.mta && e.mta instanceof o) {
        var r;
        t && e.mta[t] ? (r = e.mta[t]).call.apply(r, [ e.mta ].concat(i)) : console.log("mta function method method not allowed!");
    } else {
        var s, c = new o();
        e.mta = c, t && c[t] ? (s = c[t]).call.apply(s, [ c ].concat(i)) : console.log("mta function method method not allowed!");
    }
};