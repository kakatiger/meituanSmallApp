    ...
    return e(r.default.mark(function e() {
        ...
        return r.default.wrap(function(e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
                if (o = a.getState(), c = o.dev.uuid) return e.abrupt("return", c);
                e.next = 3;
                break;
              ...
              case 6:
                if (d = e.sent, (p = d.data) && "string" == typeof p) return a.dispatch((0, t.loadedUUID)({
                    uuid: p
                })), e.abrupt("return", p);
                e.next = 11;
                break;
              ...
              case 20:
                ...
                if (h && "string" == typeof h) return a.dispatch((0, t.storeUUID)({
                    uuid: h
                })), e.abrupt("return", h);
                e.next = 27;
                break;
