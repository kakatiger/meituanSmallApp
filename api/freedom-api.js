...
}, o = require("../npm/@dp/owl-wxapp/es6/index.js"), i = require("../utils/deal-region-set.js").setUrl, a = require("../utils/promisify.js").obj, u = require("../utils/param.js"), c = require("../store.js"), s = a(o.request), m = {
        ...
        return n.default.wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
                ...
                }), a = c.getState(), l = (l = a.dev.env) || "online", e.domain ? Object.keys(m).forEach(function(t) {
                    m[t] = e.domain;
                }) : (m = {
                    online: "https://activity.waimai.meituan.com/",
                    st: "https://activity.waimai.meituan.com/",
              ...
              case 17:
                return e.isRequest = !0, t.abrupt("return", s(e));
